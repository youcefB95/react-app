        ...
        <div className='cards__wrapper' >
          <ul className='cards__items'>
            <CardItem
              ...
              path={{ pathname: "https://github.com/youcefB95/skin-lesion-classification" }}
            />
            <CardItem
              ...
              path={{ pathname: "https://github.com/youcefB95/image-detection-MaskRCNN" }}
            />
          </ul>
          <ul className='cards__items'>
            {/* {/* <CardItem
            ...
            <CardItem
              ...
              path={{ pathname: "https://github.com/youcefB95/NLP-twitter-sentiment-analysis" }}
            /> 
            ...
            <CardItem
              ...
              path={{ pathname: "https://github.com/youcefB95/Hadoop-metrics-anomaly-detection" }}
            /> 
